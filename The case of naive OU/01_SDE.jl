...
# ╔═╡ fa82a830-7546-11ec-13bb-3923df75ed45
begin
	using DifferentialEquations
	using Plots
end

# ╔═╡ b45fe496-a410-4b69-b71a-f48f3ae6405b
let
	f(u,p,t) = 1.01*u
	u0 = 1/2
	tspan = (0.0,1.0)
...
# ╔═╡ e2f8e238-e148-4015-b115-b31afd5faedc
md"# Stochastic Differential Equations"

# ╔═╡ 36bd0de5-a514-48f1-95c7-ee222e88574f
md"## Example 1: Scalar SDEs"

# ╔═╡ dbed62b3-e878-4e69-9446-aa3a993127a1
let
	α=1
	β=1
	u₀=1/2
